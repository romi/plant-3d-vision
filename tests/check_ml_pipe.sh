...
# 2. clean
romi_run_task --config ../config/test_ml_pipe.toml Clean testdata/real_plant/ --local-scheduler
# 3. run pipeline
romi_run_task --config ../config/test_ml_pipe.toml AnglesAndInternodes testdata/real_plant/ --local-scheduler
...
# 5. run pipeline
romi_run_task --config ../config/ml_pipe_vplants_3.toml AnglesAndInternodes testdata/virtual_plant/ --local-scheduler
