...
# 2. clean
romi_run_task --config ../config/test_ml_pipe.toml Clean testdata/virtual_plant/ --local-scheduler
# 3. run pipeline
romi_run_task --config ../config/test_ml_pipe.toml AnglesAndInternodes testdata/virtual_plant/ --local-scheduler
