...
# masking_2 = masking.LinearMasking([0.0, 1.0, 0.0, 0.3], dilation=3)
masking_3 = masking.VesselMasking(0.1, 2, dilation=3)
...
masking_3.read_input(scan, 'images')
masking_3.process()
masking_3.write_output(scan, 'masks_3')
