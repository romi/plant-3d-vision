...
class AnglesAndInternodesEvaluation(EvaluationTask):
    ...
    romi_run_task AnglesAndInternodesEvaluation /data/ROMI/DB/arabido_test4 --config plant-3d-vision/config/geom_pipe_real.toml --module plant3dvision.tasks.evaluation
