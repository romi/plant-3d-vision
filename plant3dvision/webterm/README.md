...
1. Configure environment variables (optional):
    ...
    export WEBTERM_USERS="/path/to/romi/users"  # default to '/myapp/users/users.csv' 
    export WEBTERM_SECRET_KEY="your-secret-key"  # randomly generated by default
    ...
    export PLANTDB_API="https://localhost/plantdb"  # default to "/api"
    ```
1. Run the application:
    ```bash
    gunicorn --worker-class eventlet -w 1 --bind 0.0.0.0:${SERVER_PORT} plant3dvision.webterm.wsgi:application
    ```
1. Access the application in your browser at `http://localhost:8080`
